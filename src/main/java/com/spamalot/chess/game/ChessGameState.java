...
public interface ChessGameState {
   ...
   * @param c  the Piece's Color
   * @param f  the File the Piece goes in (1-8)
   * @param r  the Rank the Piece goes in (1-8)
   */
   ...
   *
   * @param pt        Queen or King, depending on the side
   * @param c         the Color
   * @param canCastle true if can castle to that side.
   */
   ...
   *
   * @param intValue number of half-moves
   */
